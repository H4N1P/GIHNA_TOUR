<div id="adminModal" class="admin-modal" aria-hidden="true">
    <div class="admin-modal__panel" role="dialog" aria-modal="true" aria-labelledby="adminModalTitle">
        ...
        <div class="admin-modal__actions">
            <button type="button" class="admin-modal__btn admin-modal__btn--ghost" data-admin-modal-cancel>Batal</button>
            <button type="button" class="admin-modal__btn admin-modal__btn--primary" data-admin-modal-confirm>Konfirmasi</button>
        </div>
    </div>
</div>
